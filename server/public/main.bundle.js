...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__shared_nav_nav_component__ = __webpack_require__("../../../../../src/app/shared/nav/nav.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__services_isLoggedIn_canactivate_service__ = __webpack_require__("../../../../../src/app/services/isLoggedIn.canactivate.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__services_restaurant_service__ = __webpack_require__("../../../../../src/app/services/restaurant.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__routes__ = __webpack_require__("../../../../../src/app/routes.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_10__shared_nav_nav_component__["a" /* NavComponent */],
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_4__angular_router__["a" /* RouterModule */].forRoot(__WEBPACK_IMPORTED_MODULE_19__routes__["a" /* routes */])
        ],
        providers: [__WEBPACK_IMPORTED_MODULE_14__services_auth_service__["a" /* AuthService */],
            __WEBPACK_IMPORTED_MODULE_15__services_isLoggedIn_canactivate_service__["a" /* IsLoggedInService */],
            __WEBPACK_IMPORTED_MODULE_16__services_restaurant_service__["a" /* RestaurantService */],
...
var MenuComponent = (function () {
    function MenuComponent(router, route, restaurantService) {
        this.router = router;
        this.route = route;
...
module.exports = "<div *ngFor=\"let restaurant of restaurants | async\">\n   <h3> {{ restaurant.name }} </h3>\n   <!-- <img [src]=\"restaurant.image\"> -->\n   <p> {{ restaurant.description }}</p>\n<a (click)=\"goToRestaurant(restaurant)\">Go to this restaurant</a>\n </div>\n"
...
var RestaurantListComponent = (function () {
    ...
    RestaurantListComponent.prototype.goToRestaurant = function (restaurant) {
        ...
        this.orderService.newOrder(referents)
            .subscribe(function () { _this.router.navigate(['/restaurants', restaurant._id]); });
    };
...
var OrderService = (function () {
    ...
    OrderService.prototype.newOrder = function (ids) {
...
module.exports = "<div class=\"container\">\n  <div class=\"card card-container\">\n    <img id=\"profile-img\" class=\"profile-img-card\" src=\"//ssl.gstatic.com/accounts/ui/avatar_2x.png\" />\n    <p id=\"profile-name\" class=\"profile-name-card\"></p>\n    <form>\n      <h2> Signup </h2>\n      <label> Username </label>\n      <input type=\"text\" [(ngModel)]=\"formInfo.username\" name=\"username\" class=\"form-control\" placeholder=\"Email address\" required autofocus/>\n      <br>\n      <label> Password </label>\n      <input type=\"password\" id=\"inputPassword\" class=\"form-control\" placeholder=\"Password\" required [(ngModel)]=\"formInfo.password\" name=\"password\" />\n\n      <button class=\"btn btn-lg btn-primary btn-block btn-signin\" type=\"submit\" (click)=\"signup()\"> signup </button>\n    </form>\n    <a href=\"#\" class=\"forgot-password\">\n    Forgot the password?\n</a>\n\n  </div>\n</div>\n"
